...
class Window(QtWidgets.QWidget):
    ...
    def __initUi(self) -> None:
        ...
        self.labelLogin = QtWidgets.QLabel("<h2>Логин</h2>")  # TODO Создайте виджет QLabel с текстом "Логин"
        self.labelRegistration = QtWidgets.QLabel("<h3>Регистрация</h3>")  # TODO Создайте виджет QLabel с текстом "Регистрация"
        ...
        self.lineEditPassword.setEchoMode(QtWidgets.QLineEdit.EchoMode.PasswordEchoOnEdit)  # TODO установите ограничение видимости вводимых знаков с помощью метода .setEchoMode()
